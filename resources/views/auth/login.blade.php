    ...
    <main class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Masukkan username dan password Anda untuk mengakses akun</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST" id="loginForm" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <a href="/forgot-password.html" class="text-sm text-indigo-600 hover:text-indigo-500">Lupa password?</a>
                </div>
                ...
                <div class="text-center text-sm text-gray-600">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-500 font-medium">Daftar sekarang</a>
                </div>
            </form>
